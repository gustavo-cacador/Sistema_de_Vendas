...
public class VendaControle {
    ...
    public ModelAndView editar(@PathVariable("id")Long id){
        ...
        this.listaItemVenda = itemVendaRepositorio.findByEntradaId(venda.get().getId());
    ...
    public List<ItemVenda> getListaItemEntrada() {
        return listaItemVenda;
    }

    public void setListaItemEntrada(List<ItemVenda> listItemVenda) {
        this.listaItemVenda = listItemVenda;
    }
